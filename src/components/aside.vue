<template>
  ...
  <p class="   dark:text-gray-300 pb-16 flex justify-center items-center">
     ...
     <div class="  gap-x-2   flex flex-row  justify-center items-center mx-auto pb-8">
       <a href="" class=" dark:border dark:border-white dark:rounded-full cursor-pointer">
...
<a href=" https://www.linkedin.com/in/evalyne-mulandi-3934b622b/"  class="  dark:border dark:border-white dark:rounded-full
cursor-pointer"> 
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
width="36" height="36"
viewBox="0 0 30 30"
...
<a href=" https://www.instagram.com/__just__her___/"  class=" dark:border dark:border-white dark:rounded-full cursor-pointer"> 
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
width="36" height="36"
viewBox="0 0 24 24"
